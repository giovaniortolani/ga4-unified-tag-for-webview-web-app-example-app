...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		webSettings.setJavaScriptEnabled(true); // IMPORTANT: FIREBASE WEBVIEW
		...
		SmartWebView.asw_view.setWebViewClient(new Callback()); // IMPORTANT: FIREBASE WEBVIEW
	...
	private class Callback extends WebViewClient {
		public void onPageStarted(WebView view, String url, Bitmap favicon) {
			...
			// Only if not using the GTM template https://github.com/giovaniortolani/ga4-unified-tag-for-webview-web-app-firebase-analytics-handler-global-variable-initialization).
